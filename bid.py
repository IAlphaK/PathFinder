    ...
    while queue_forward and queue_backward:
        ...
        for neighbor_forward in neighbors_forward:
            if neighbor_forward not in visited_forward:
                ...
                weight = graph.get_edge_data(node_forward, neighbor_forward)['w']  # Get the weight of the edge
        ...
        for neighbor_backward in neighbors_backward:
            if neighbor_backward not in visited_backward:
                ...
                weight = graph.get_edge_data(node_backward, neighbor_backward)['w']  # Get the weight of the edge
